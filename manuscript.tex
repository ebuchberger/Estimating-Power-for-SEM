...
The latest supplementary materials for this article are available on \href{https://github.com/ebuchberger/Estimating-Power-for-SEM}{GitHub} (Buchberger, Ngo, Peikert, Brandmaier, \& Werkle-Bergner, 2024). The version of code and data used as the basis for this PDF is ``2a97a34''.
