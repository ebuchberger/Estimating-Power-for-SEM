...
authornote: |
  ...
  The latest supplementary materials for this article are availible at <https://github.com/ebuchberger/Estimating-Power-for-SEM>. The version of code and data used as the basis for this PDF is "`r paste0(repro::current_hash(backend = 'gert'))`".
