...
Note that in this tutorial, we limited our analyses to investigating the impact of either the separability of the theoretical constructs or the impact of the reliability of the estimates by keeping the other parameter constant throughout the simulation. The interaction of these parameters may differentially impact the resultant sample size estimates. However, a thorough investigation of the interaction of the two influencing factors would exponentially increase the number of conditions in a simulation. In our example on memory component processes, we have no theory-driven predictions with regards to the separability of the constructs and the reliability of the indicators’ interaction. Thus, we confine the current analysis to separate analyses in the interest of conciseness. For cases in which researchers are interested in testing a particular interaction effect between such parameters, we recommend to expand the conditions of the simulation accordingly.
...
# Open Practices Statement {-}
  ...
  The supplementary materials for this article (including the data and R scripts) are publically available at <https://github.com/ebuchberger/Estimating-Power-for-SEM>. The analyses reported in this manuscript were not preregistered.
